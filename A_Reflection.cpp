...
int reflect(int a){
    ...
    while (a)
    {
        reflection += t*(9 - a%10); t*=10; a/=10;
    }

    return reflection;
}

int digit_count(int r){
...
int32_t main(){
    ...
    int gold = golden_number(digit_count(r));

    if(gold >= l and gold <= r){

        cout << gold*reflect(gold) << endl;
    }

    else if(l > gold) cout << l*reflect(l) << endl;

    else cout << r*reflect(r) << endl;
