...
int32_t main(){
    ...
    if(n == 1){
        ...
        int count_even_a = 0; int count_odd_a = 0;
        ...
        if(count_even_a > count_odd_a){
            
            cout << sz(input) - count_even_a << endl;
            ...
            cout << sz(input) - count_odd_a << endl;
        ...
        // k > 2;
        input.push_back(input[sz(input)-1]);
        ...
        loop(i, 0, sz(input)-2){
            ...
            if(input[i] == input[i+1]){
                ...
                input[i + 1]  = complement(input[i], input[i+2]); ount ++; 
            }
        }
        cout << ount << endl;

        cout << input.substr(0, sz(input)-1) << endl;
