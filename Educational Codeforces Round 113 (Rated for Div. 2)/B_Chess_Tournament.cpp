    ...
    test_cases_loop{
        ...
        for(int i = 0; i < n; i++) 
            ...
            if(s[i] == '2') 
                ...
                count++, indicesOfTwos.push_back(i);

        // print<int>(indicesOfTwos); cout.flush();

        vector<string> matrix(sz(s), string(sz(s), '='));

        int it = 0;

        if(count != 0 and count < 3) cout << "NO" << endl;
            ...
            for(int r = 0; r < n; r++){
                ...
                if(s[r] == '2') 
                    ...
                    indexForPlus = indicesOfTwos[(++it)%sz(indicesOfTwos)],

                    matrix[r][indexForPlus] = '+',

                    matrix[indexForPlus][r] = '-';
            }
