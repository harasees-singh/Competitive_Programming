...
int32_t main(){
    ...
    test_cases_loop{
        ...
        string one; cin >> one; string two; cin >> two;

        vi enemy; loop(i, 0, n){int t; t = one[i] - '0'; enemy.pb(t);}

        vi pawns; loop(i, 0, n){int t; t = two[i] - '0'; pawns.pb(t);}
        ...
        for(int i = 0; i < n; i++){
            ...
            if(pawn){
                ...
                if(!ene) count++;
                    ...
                    if(i and enemy[i-1] and !visited[i-1]){
                    ...
                    else if(i < n-1 and enemy[i+1] and !visited[i+1]){
