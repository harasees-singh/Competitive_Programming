...
int32_t main(){
    ...
    test_cases_loop{
        ...
        unordered_map<int, int, custom_hash> storeindex;

        vi input; loop(i, 0, n){int t; cin >> t; input.pb(t); storeindex[t] = i;}
        ...
        while(curr <= n - 2){
            ...
            while(curr <= n-2 and storeindex[input[curr + 1]] == storeindex[input[curr]] + 1){
        ...
        string ans; count + 1 <= k ? ans = "Yes" : ans = "No"; cout << ans << endl;
    }
